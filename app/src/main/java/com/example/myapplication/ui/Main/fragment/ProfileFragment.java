...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE)
            ...
            // state#1 dar soorati k qablan mojaveze dasresi nadade
        } else {
            // state#2 dar soorati k qablan mojaveze dasresi dade
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String permissions[], @NonNull int[] grantResults) {
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE: {
               ...
               //state#3 alan ejaze dasresi dade va allow zade shode
                } else {
              //state#4 alan ham ejaze dasresi nadade va deny zade shode
